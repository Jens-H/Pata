...
public class PataDatabaseMetaData implements DatabaseMetaData
{
    PataConnection conn;

    public PataDatabaseMetaData(PataConnection conn)
    {
        this.conn = conn;
    }
    ...
    public String getURL() throws SQLException {
        return "jdbc:duckdb-pata:" + conn.connectionSocketChannel.socket().getLocalPort();
    }
