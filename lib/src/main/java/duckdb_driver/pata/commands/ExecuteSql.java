...
public class ExecuteSql implements PataCommand
{
	public static final String op = "ExecuteSql";
	public final String sql;
	public final UUID statementID;
	
	public ExecuteSql(JsonParser jsonParser) throws Exception
	{
		String tmpSql = null;
		UUID tmpId = null;
	...
	public ExecuteSql(String sql, UUID statementID)
	{
		this.sql = sql;
