...
public class PrepareSql implements PataCommand
{
	public static final String op = "PrepareSql";
	public final String sql;
	public final UUID statementID;
	
	public PrepareSql(JsonParser jsonParser) throws Exception
	{
		String tmpSql = null;
		UUID tmpId = null;
	...
	public PrepareSql(String sql, UUID statementID)
	{
		this.sql = sql;
